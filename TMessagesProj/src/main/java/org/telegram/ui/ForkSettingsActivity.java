...
public class ForkSettingsActivity extends BaseFragment {
    ...
    public static final int ID_USE_CAMERAX = 58;
    ...
    private void fillSettings(ArrayList<UItem> items) {
        ...
        items.add(UItem.asButtonCheck(ID_SYSTEM_CAMERA, LocaleController.getString(R.string.SystemCamera), LocaleController.getString(R.string.SystemCameraInfo))
            ...
            .setMultiline(true));
        items.add(UItem.asButtonCheck(ID_USE_CAMERAX, LocaleController.getString(R.string.UseCameraX), LocaleController.getString(R.string.UseCameraXInfo))
            .setChecked(pref("useCameraX", false))
            .setEnabled(SharedConfig.inappCamera)
            .setMultiline(true));
    ...
    private void onClick(UItem item, View view, int position, float x, float y) {
        ...
        } else if (id == ID_USE_CAMERAX) {
            if (SharedConfig.inappCamera) {
                toggle("useCameraX", item, view);
            }
